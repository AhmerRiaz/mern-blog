...
import { userUpdateStart, userUpdateSuccess, userUpdateFailure, 
  userDeleteStart, userDeleteSuccess, userDeleteFailure, userSignOutStart, userSignOutSuccess, userSignOutFailure } from "../redux/user/userSlice";
...
export default function DashProfile() {
  ...
  console.log('image file is uploading', imageFileUploading);
 ...
 const handleSubmit = async (e) => {
  ...
  setUpdateUserSuccess(null);
   ...
   if (imageFileUploading){
    setUpdateUserError('Image file is uploading');
    return;
   }
 ...
 const handleDeleteAccount = async () => {
   ...
   try {
    ...
    if(!res.ok) {
      ...
      //Private route handling the redirect
    ...
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        onClick={() => filePicker.current.click()}>
          ...
          className={`rounded-full w-full h-full object-cover border-7 border-[lightgray] 
        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <Button color='failure' onClick={handleDeleteAccount}>Yes, I'm</Button>
