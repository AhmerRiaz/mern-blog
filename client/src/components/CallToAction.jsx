...
export default function CallToAction() {
  return (
    ...
    rounded-tl-3xl rounded-br-3xl text-center">
        ...
        <Button className="rounded-tl-xl rounded-bl-none" gradientDuoTone={"purpleToPink"}><a href="https://www.100jsprojects.com" target="_blank" rel="noopener noreferrer">100 Js Projects</a></Button>
        </div>
